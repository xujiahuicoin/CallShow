...
open class BFRefreshNoNetworkView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor = CSID_BackgroundColor_dark
        setupUI()
    }
    ...
    // MARK: - Event response
    @objc
    func tipButtonAction(_AnNiuButton: UIButton) {
    ...
    public lazy var tipButton: UIButton = { [weak self] in
        ...
        button.addTarget(self, action: #selector(tipButtonAction(_AnNiuButton:)), for: .touchUpInside)
        return button
    }()
