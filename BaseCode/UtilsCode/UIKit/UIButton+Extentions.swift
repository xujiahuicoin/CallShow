...
func returnBtnGoogleColor(title: String,imageName:String?, color1R2Y3G: Int) -> UIButton {
    ...
    let btn = UIButton(Xframe: CGRect.zero, title: title, titleColor: CSID_MainTextColor, font: .boldSystemFont(ofSize: 15), backgroundColor: color1R2Y3G == 1 ? RGB(193, g: 81, b: 71) : (color1R2Y3G == 2 ? RGB( 242, g: 204, b: 79) : RGB( 92, g: 159, b: 97))  , imageName: "", cornerRadius: 8)
    if imageName != nil {
