...
@objc protocol CSID_ViewEventsDelegate : NSObjectProtocol {
    
    @objc optional func CSID_UIViewCollectEvent(eventObject : ViewEventObject)
}

class CSID_BaseView: UIView,NVActivityIndicatorViewable {
...
//    子类重写
    func initCSID_View() {}
    func initCSID_View(parmas : ViewDataObject) {
...
//    弹出指示器
    func CSID_showHUD(_ loadingType : NVActivityIndicatorType = .ballSpinFadeLoader, color : UIColor = CSID_MainTextColor, padding : CGFloat = 50.0) {
