...
class CSID_AlertView{
    ...
    ///弹框---两个按钮提示
    func showDoubleButton(title:String,leftTitle:String,rightTitle:String,message:String,leftAction:@escaping()->(),rightAction:@escaping()->()){
        
        let alertView = SCLAlertView()
        alertView.addButton(leftTitle){
            leftAction()
        }
